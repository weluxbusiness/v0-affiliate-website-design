...
export const metadata: Metadata = {
  ...
  description: "Transform your home for less! Find deals on kitchen appliances, furniture, home decor, and more from Target, Williams-Sonoma, and Dyson.",
  openGraph: {
    title: "Home & Kitchen Deals & Discounts | SaveSmart",
    description: "Find amazing home and kitchen deals on appliances, furniture, decor and more. Updated hourly.",
    type: "website",
    url: "https://savesmart.bio/deals/home-kitchen",
  },
  alternates: {
    canonical: "/deals/home-kitchen",
  },
}
...
const topStores = ["Target", "Dyson", "Williams-Sonoma"]

export default async function HomeKitchenDealsPage() {
  const deals = await getDealsByCategory("Home & Kitchen", 12)
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-emerald-600 to-teal-700 text-white py-12 md:py-16 overflow-hidden">
          ...
          <PageContainer className="relative">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-emerald-200 uppercase tracking-wider text-sm font-medium">Category</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4">
              Home & Kitchen Deals
            </h1>
            <p className="text-xl text-emerald-100 max-w-2xl mb-8">
              Transform your space for less! Discover deals on appliances, furniture, decor, and more.
            </p>
        ...
        <section className="bg-card border-b border-border py-6">
          <PageContainer>
            <div className="flex flex-wrap items-center gap-6 justify-center">
              <span className="text-sm text-muted-foreground">Top Home Stores:</span>
          ...
          <PageContainer>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="outline" className="gap-2" asChild>
                <Link href="/deals?category=home-kitchen">
                  View All
        ...
        <section className="py-12 md:py-16 text-center">
          <PageContainer>
            <h2 className="text-2xl font-bold text-foreground mb-2">Looking for a specific home product?</h2>
            <p className="text-muted-foreground mb-6">Our AI can help you find the perfect deals for your home.</p>
