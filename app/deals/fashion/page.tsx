...
export const metadata: Metadata = {
  title: "Fashion Deals & Discounts",
  description: "Shop the latest fashion deals! Find discounts on clothing, shoes, accessories, and more from Nike, Adidas, Levi's and top brands.",
  openGraph: {
...
const topStores = ["Nike", "Adidas", "Levi's"]

export default async function FashionDealsPage() {
  const deals = await getDealsByCategory("Fashion", 12)
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-pink-500 to-rose-600 text-white py-12 md:py-16 overflow-hidden">
          ...
          <PageContainer className="relative">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-pink-200 uppercase tracking-wider text-sm font-medium">Category</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4">
              Fashion Deals
            </h1>
            <p className="text-xl text-pink-100 max-w-2xl mb-8">
              Look great for less! Discover amazing deals on clothing, shoes, and accessories from top brands.
            </p>
        ...
        <section className="bg-card border-b border-border py-6">
          <PageContainer>
            <div className="flex flex-wrap items-center gap-6 justify-center">
              <span className="text-sm text-muted-foreground">Top Fashion Brands:</span>
        ...
        {featuredDeals.length > 0 && (
          <section className="py-12 md:py-16">
            <PageContainer>
              <h2 className="text-2xl font-bold text-foreground mb-6">Featured Fashion Deals</h2>
              <DealGrid columns={3}>
        ...
        <section className="bg-muted/30 py-12 md:py-16">
          <PageContainer>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-foreground">All Fashion Deals</h2>
              <Button variant="outline" className="gap-2" asChild>
                <Link href="/deals?category=fashion">
                  View All
        ...
        <section className="py-12 md:py-16 text-center">
          <PageContainer>
            <h2 className="text-2xl font-bold text-foreground mb-2">Looking for a specific brand?</h2>
            <p className="text-muted-foreground mb-6">Our AI can help you find the best fashion deals tailored to your style.</p>
